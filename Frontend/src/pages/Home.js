        ...
        return (
            <div>
                <h3>Welcome to this demo project, meant as a frontend-seed for third semester at:<br />
                    <a href="https://www.cphbusiness.dk/english/study-programmes/ap-degree/computer-science/">cphbusiness.dk
                        - ComputerScience</a>
                </h3>
                <h4>This project assumes it's' corresponding backend is running</h4>
                <h4>This project assumes it's corresponding backend is running on port 8084 (can be changed in
                    package.json)</h4>
